...
CREATE TABLE `food` (
  ...
  `price` decimal(10,2) NOT NULL DEFAULT 0 -- Added price column
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 9, 'Dosa', 'I love Dosa very much. Its a South Indian Food and Everybody loves it!', 50.00),
(7, 7, 'Egg Role', 'This is a North Indian Pop Food. Everybody likes it so damn very much.', 15.00),
(8, 8, 'Chowmin', 'This is a Chinese Pop Food. Everybody likes it so damn very much.', 20.00),
(9, 10, 'French Fries', 'This is a Snacks Food. Everybody likes it so damn very much with Tea or Coffee.', 60.00),
(10, 11, 'Momos', 'This is a Himalayan Pop Food. Everybody likes it so damn very much. Its comes with different flavors!', 100.00),
(11, 8, 'Hakka Noodles', 'This food is so much popular even in India. It tastes like Chowmein but with Gravy.', 50.00);
